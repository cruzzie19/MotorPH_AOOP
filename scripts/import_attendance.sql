...
--   for windows : & "C:\Program Files\PostgreSQL\18\bin\psql.exe" -U postgres -d motorph -f scripts/import_attendance.sql
--   for macOS or linux : psql -d motorph -f scripts/import_attendance.sql 
