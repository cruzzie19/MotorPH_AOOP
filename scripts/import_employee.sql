...
--   for windows : & "C:\Program Files\PostgreSQL\18\bin\psql.exe" -U postgres -d motorph -f scripts/import_employee.sql
--   for macOS or linux : psql -d motorph -f scripts/import_employee.sql 
